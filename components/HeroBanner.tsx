  ...
  const handleCheckUser = async () => {
    ...
    try {
      ...
      if (data.valid) {
        ...
        setCheckError(data.error || "Username tidak ditemukan");
      }
    } catch {
    ...
    <section id="beranda" className="relative w-full overflow-hidden isolate">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-4 pb-0 lg:pt-6 lg:pb-0 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-7 flex flex-col items-start pb-2 sm:pb-4">
            
            {/* Region Star Badge with Authentic Vietnam Flag */}
            <div className="inline-flex items-center gap-1.5 sm:gap-2 pl-1 pr-3 sm:pr-3.5 py-1 rounded-full bg-gradient-to-r from-[#FF3B7D] via-[#FF5388] to-[#FF75A2] border border-white/60 shadow-[0_4px_14px_rgba(255,59,125,0.35)] mb-2.5 sm:mb-3 hover:scale-105 transition-transform">
              <div className="relative w-4.5 h-4.5 sm:w-5 sm:h-5 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 shadow-sm border border-white/80">
              ...
              <span className="text-[10px] sm:text-xs font-black text-white tracking-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.15)]">
                Distributor Resmi Region Vietnam
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-2xl sm:text-4xl lg:text-[2.85rem] font-black tracking-tight text-slate-900 leading-[1.12] sm:leading-[1.08] mb-2 sm:mb-2.5">
              Top Up Robux <br className="hidden xs:inline" />
            ...
            {/* Subtitle */}
            <p className="text-xs sm:text-sm text-slate-700 font-medium leading-relaxed max-w-md mb-3 sm:mb-4">
              Robux masuk hanya dengan username Roblox. Aman, cepat, dan terpercaya.
            </p>

            {/* Trust Badges Pills */}
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-3.5 sm:mb-5">
              {/* Pill 1 */}
              <div className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-white/95 backdrop-blur-md border border-amber-100 shadow-[0_2px_8px_rgba(255,184,0,0.15)] text-slate-800 text-[11px] sm:text-xs font-bold hover:scale-105 transition-transform">
                <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-md bg-amber-100 flex items-center justify-center text-amber-600">
              ...
              {/* Pill 2 */}
              <div className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-white/95 backdrop-blur-md border border-emerald-100 shadow-[0_2px_8px_rgba(16,185,129,0.15)] text-slate-800 text-[11px] sm:text-xs font-bold hover:scale-105 transition-transform">
                <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-md bg-emerald-100 flex items-center justify-center text-emerald-600">
              ...
              {/* Pill 3 */}
              <div className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-white/95 backdrop-blur-md border border-pink-100 shadow-[0_2px_8px_rgba(255,46,116,0.15)] text-slate-800 text-[11px] sm:text-xs font-bold hover:scale-105 transition-transform">
                <div className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-md bg-pink-100 flex items-center justify-center text-[#FF2E74]">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4 sm:mb-5 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 sm:px-5 py-2.5 sm:py-3 rounded-full bg-white/95 backdrop-blur-md border border-pink-200/90 text-slate-800 font-bold text-xs sm:text-sm shadow-xs hover:bg-pink-50 hover:border-pink-300 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer"
              >
                <div className="w-4.5 h-4.5 sm:w-5 sm:h-5 rounded-full bg-pink-500/10 flex items-center justify-center text-[#FF2E74]">
                  <Play className="w-2 sm:w-2.5 h-2 sm:h-2.5 fill-[#FF2E74]" />
                </div>
            ...
            {/* Payment Methods */}
            <div className="w-full pt-2.5 sm:pt-3 border-t border-pink-200/60">
              <span className="block text-[10px] sm:text-[11px] font-bold text-slate-600 uppercase tracking-wider mb-1.5 sm:mb-2">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                {paymentLogos.map((payment) => (
                  <div
                    key={payment.name}
                    className="h-6 sm:h-7 px-1.5 sm:px-2 py-0.5 rounded-lg bg-white/95 backdrop-blur-sm border border-slate-200/80 shadow-xs flex items-center justify-center hover:scale-105 transition-transform"
                    title={payment.name}
                  >
                    <img
                      src={payment.src}
                      alt={`${payment.name} Logo`}
                      className="h-full w-auto max-h-3.5 sm:max-h-4 object-contain"
                    />
                  </div>
                ))}
          ...
          <div className="lg:col-span-6 xl:col-span-5 relative flex items-end justify-center lg:justify-end">
            ...
            {/* Character Wrapper */}
            <div className="relative w-full max-w-[280px] sm:max-w-[440px] lg:max-w-[500px] h-[220px] sm:h-[380px] lg:h-[500px] flex items-end justify-center translate-y-2 sm:translate-y-8 lg:translate-y-12">
              ...
              <div className="absolute top-[35%] -right-1 sm:right-1 z-30 animate-float-reverse pointer-events-none scale-90 sm:scale-100 origin-right">
                <div className="px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-white/95 backdrop-blur-md shadow-[0_6px_16px_rgba(255,46,116,0.2)] border border-pink-100 flex items-center gap-1 text-[10px] sm:text-[11px] font-black text-[#FF2E74]">
                  <span>More Robux More Happiness!</span>
                  <Heart className="w-2.5 sm:w-3 h-2.5 sm:h-3 fill-[#FF2E74]" />
                </div>
              </div>

              {/* Floating Trust Badge: 10.000+ Players */}
              <div className="absolute bottom-6 sm:bottom-16 right-0 sm:right-2 z-30 scale-90 sm:scale-100 origin-bottom-right">
                <div className="px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl bg-white/95 backdrop-blur-md shadow-[0_8px_20px_rgba(0,0,0,0.1)] border border-pink-100 flex items-center gap-2">
      ...
      <div id="pricelist" className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-30 pt-0 pb-6 flex flex-col gap-3 sm:gap-3.5 scroll-mt-24">
        
        {/* Main Quick Top Up Card */}
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 shadow-[0_12px_35px_rgba(255,105,180,0.18)] border border-pink-100/90 scroll-mt-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5 sm:gap-4 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col gap-1 sm:gap-1.5">
              ...
              <div className="relative flex items-center">
                {/* Avatar thumbnail when verified */}
                {userAvatar && verifiedUser ? (
                  <div className="absolute left-1.5 w-6 h-6 rounded-full overflow-hidden border-2 border-emerald-400 flex-shrink-0">
                    <img src={userAvatar} alt={verifiedUser} className="w-full h-full object-cover" />
                  </div>
                ) : (
                  <div className={`absolute left-3 ${checkError ? "text-red-400" : "text-slate-400"}`}>
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-20 py-2.5 bg-slate-50/90 hover:bg-slate-50 focus:bg-white border rounded-xl text-xs sm:text-sm font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 transition-all ${
                    verifiedUser
                      ? "border-emerald-400 focus:border-emerald-500 focus:ring-emerald-100"
                      : checkError
                      ? "border-red-300 focus:border-red-400 focus:ring-red-100"
                      : "border-slate-200 focus:border-[#FF2E74] focus:ring-pink-100"
                  }`}
                />
                <button
                  onClick={handleCheckUser}
                  disabled={isCheckingUser || !username.trim()}
                  className="absolute right-1 px-3 sm:px-3.5 py-1.5 rounded-lg bg-gradient-to-r from-[#FF2E74] to-[#FF5588] text-white font-bold text-xs shadow-xs hover:opacity-90 active:scale-95 disabled:opacity-50 transition-all cursor-pointer"
                >
              ...
              {/* Feedback message */}
              {verifiedUser && (
                <p className="text-[10px] sm:text-[11px] font-semibold text-emerald-600 flex items-center gap-1 pl-1">
                  <CheckCircle2 className="w-3 h-3 flex-shrink-0" />
                  Akun: <span className="font-black truncate">{verifiedUser}</span>
                </p>
              )}
              {checkError && !verifiedUser && (
                <p className="text-[10px] sm:text-[11px] font-semibold text-red-500 pl-1">
                  ✕ {checkError}
                </p>
              )}
            </div>
            ...
            <div className="lg:col-span-8 flex flex-col gap-1 sm:gap-1.5">
              <div className="flex items-center justify-between">
                <span className="text-xs sm:text-sm font-extrabold text-slate-900 flex items-center gap-1.5">
              ...
              <div className="flex items-center justify-center pt-0.5">
                <div
                  ...
                  className="group relative w-24 sm:w-36 h-1.5 bg-slate-100 hover:bg-pink-100/80 rounded-full cursor-pointer transition-colors overflow-hidden"
        ...
        <div className="lg:hidden relative w-full overflow-hidden py-0.5 [mask-image:linear-gradient(to_right,transparent,black_4%,black_96%,transparent)]">
          <div className="animate-marquee flex items-center gap-3">
            {[...quickFeatures, ...quickFeatures].map((item, idx) => {
              const Icon = item.icon;
              return (
                <div
                  key={idx}
                  className="flex-shrink-0 flex items-center gap-3 px-3.5 py-2.5 rounded-2xl bg-white/95 backdrop-blur-md border border-pink-100/90 shadow-[0_4px_16px_rgba(255,182,193,0.14)]"
                >
                  {/* Circular Icon Container */}
                  <div className={`w-9 h-9 rounded-full ${item.bgColor} border flex items-center justify-center flex-shrink-0 shadow-xs`}>
                  ...
                  <div className="flex flex-col whitespace-nowrap">
                    ...
                    <span className="text-[10px] font-semibold text-slate-500 mt-0.5 leading-tight">
                      {item.subtitle}
                    </span>
                  </div>
                </div>
