  ...
  return (
    <footer className="relative bg-[#FFF0F5] text-slate-700 pt-12 pb-14 border-t border-pink-200/70 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 lg:gap-6 items-start">
          ...
          <div className="md:col-span-4 lg:col-span-3 flex flex-col items-start">
            ...
            {/* Slogan */}
            <p className="text-xs sm:text-sm font-black italic text-[#FF2E74] flex items-center gap-1.5 mb-4 sm:mb-6">
          ...
          {/* Col 2 & 3 Combined in 2-col row on mobile */}
          <div className="md:col-span-4 lg:col-span-4 grid grid-cols-2 gap-4 sm:gap-6">
            {/* Col 2: Menu */}
          ...
          {/* Col 4: Ikuti Kami */}
          <div className="md:col-span-4 lg:col-span-2 flex flex-col gap-2 sm:gap-2.5">
            <h4 className="text-xs sm:text-sm font-black text-slate-900 tracking-tight">
              Ikuti Kami
            </h4>
            <div className="grid grid-cols-2 md:flex md:flex-col gap-2 sm:gap-2.5 text-xs font-semibold text-slate-700">
              {/* Instagram */}
              <a
              ...
              >
                <div className="w-5 h-5 rounded-md bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 flex items-center justify-center text-white shadow-xs group-hover:scale-110 transition-transform flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center gap-2 hover:text-[#FF2E74] transition-colors group p-1 sm:p-0"
              >
                <div className="w-5 h-5 rounded-md bg-black flex items-center justify-center text-white shadow-xs group-hover:scale-110 transition-transform flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center gap-2 hover:text-[#FF2E74] transition-colors group p-1 sm:p-0"
              >
                <div className="w-5 h-5 rounded-md bg-[#25D366] flex items-center justify-center text-white shadow-xs group-hover:scale-110 transition-transform flex-shrink-0">
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex items-center gap-2 hover:text-[#FF2E74] transition-colors group p-1 sm:p-0"
              >
                <div className="w-5 h-5 rounded-md bg-[#FF0000] flex items-center justify-center text-white shadow-xs group-hover:scale-110 transition-transform flex-shrink-0">
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-12 lg:col-span-3">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 sm:p-5 border border-pink-200/80 shadow-xs flex items-center gap-3.5 sm:gap-4 hover:shadow-md transition-shadow">
              {/* Instagram Glossy 3D Icon Badge */}
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#833AB4] flex items-center justify-center flex-shrink-0 shadow-md p-2.5 sm:p-3 text-white">
              ...
              <div className="flex flex-col items-start min-w-0 flex-1">
                ...
                <span className="text-[10px] sm:text-[11px] text-slate-500 font-semibold mt-0.5 leading-tight mb-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-[#FF2E74] to-[#FF5588] text-white font-extrabold text-[10px] sm:text-[11px] shadow-sm hover:opacity-90 active:scale-95 transition-all"
                >
            ...
            {/* Mobile Copyright */}
            <p className="text-[10px] font-semibold text-slate-400 text-center mt-4 md:hidden">
              © {new Date().getFullYear()} VietBlox. Semua hak dilindungi.
            </p>
          </div>
